      ...
      <div className="mx-auto w-full max-w-[1440px] px-6 pb-24 pt-6">
        ...
        <div className="mx-auto w-full xl:max-w-[1200px]">
          <section className="relative mt-10 rounded-[2px] bg-white pb-10 pt-16 shadow-[0px_2px_3px_rgba(0,0,0,0.108696)]">
            <div className="absolute left-1/2 top-0 h-[120px] w-[120px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#ECEFF3]" />
            <div className="mx-auto h-[48px] w-48 rounded bg-[#F0F1F4]" />
            <div className="mx-auto mt-1 h-6 w-56 rounded bg-[#ECEFF3]" />
          </section>

          <section className="mt-10">
            <div className="flex items-center justify-between">
              <div className="h-[48px] w-40 rounded bg-[#ECEFF3]" />
              <div className="flex items-center gap-2">
                <div className="h-6 w-6 rounded bg-[#F0F1F4]" />
                <div className="h-6 w-6 rounded bg-[#F0F1F4]" />
              </div>
            </div>
            ...
            <div className="mt-4 grid gap-y-4 sm:grid-cols-2 sm:gap-x-4 lg:grid-cols-2 lg:gap-x-4 xl:grid-cols-3 xl:gap-x-[15px]">
              {Array.from({ length: 6 }).map((_, index) => (
                <div
                  key={index}
                  className="h-[296px] rounded-[2px] bg-white p-6 shadow-[0px_2px_3px_rgba(0,0,0,0.108696)] lg:p-8"
                >
